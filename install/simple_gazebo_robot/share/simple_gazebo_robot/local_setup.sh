...
: ${AMENT_CURRENT_PREFIX:="/ros2/install/simple_gazebo_robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_gazebo_robot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_gazebo_robot/environment/path.sh"
